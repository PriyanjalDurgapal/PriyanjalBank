...
export default function CustomerLogin() {
  ...
  const slides = [
    { image: "images.jpeg", title: "Welcome Back", subtitle: "Secure access to your banking services" },
    { image: "/stars.jpg", title: "Digital Banking", subtitle: "Manage your money anytime, anywhere" },
  ];
